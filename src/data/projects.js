export const DATA = {
  ...
  projects: [
    {
      ...
      images: [
        ...
        {
          src: 'https://i.imgur.com/Alu1OEg.jpg',
          details: { drone: "DJI Mini 4 Pro", settings: "auto", postProcessing: "none" }
        },
        {
          src: 'https://i.imgur.com/9zKImpt.jpg',
          details: { drone: "DJI Mini 4 Pro", settings: "auto", postProcessing: "none" }
        },
        {
          src: 'https://i.imgur.com/vBtdrcB.jpg',
    ...
    },
    {
      ...
      images: [
        {
          src: 'https://i.imgur.com/wTKWhxH.jpg',
          details: { drone: "DJI Air 3S", settings: "auto", postProcessing: "none" }
        },
        {
          src: 'https://i.imgur.com/LLD61GE.jpg',
          details: { drone: "DJI Air 3S", settings: "auto", postProcessing: "none" }
        },
        {
          src: 'https://i.imgur.com/BCEwLLd.jpg',
          details: { drone: "DJI Air 3S", settings: "auto", postProcessing: "none" }
        },
        {
          src: 'https://i.imgur.com/FyBCgmt.jpg',
          details: { drone: "DJI Air 3S", settings: "auto", postProcessing: "none" }
        },
        {
          src: 'https://i.imgur.com/yaHqBPr.jpg',
          details: { drone: "DJI Air 3S", settings: "auto", postProcessing: "none" }
        },
        {
          src: 'https://i.imgur.com/Om3NMfF.jpg',
          details: { drone: "DJI Air 3S", settings: "auto", postProcessing: "none" }
        },
      ],
    ...
    },
    {
      ...
      images: [
        {
          src: 'https://i.imgur.com/n4aAv4y.jpg',
          details: { drone: 'DJI Mini 4 Pro', settings: 'auto', postProcessing: 'none' }
        },
        {
          src: 'https://i.imgur.com/AqADiZB.jpg',
          details: { drone: 'DJI Mini 4 Pro', settings: 'auto', postProcessing: 'none' }
        },
        {
          src: 'https://i.imgur.com/qaFoTtx.jpg',
          details: { drone: 'DJI Mini 4 Pro', settings: 'auto', postProcessing: 'none' }
        },
        {
          src: 'https://i.imgur.com/Kknpq08.jpg',
          details: { drone: 'DJI Mini 4 Pro', settings: 'auto', postProcessing: 'none' }
        },
      ],
  ...
  gallery: [
    {
      id: 1,
      src: 'https://i.imgur.com/JcYMLbs.jpg',
      location: 'Toledo',
    ...
    {
      id: 2,
      src: 'https://i.imgur.com/24ww2T8.jpg',
      location: 'Denver',
    ...
    {
      id: 3,
      src: 'https://i.imgur.com/MOpItb5.jpg',
      location: 'Lisboa',
    ...
    {
      id: 4,
      src: 'https://i.imgur.com/Hdj46ri.jpg',
      location: 'Valencia',
    ...
    {
      id: 5,
      src: 'https://i.imgur.com/NCGqQX6.jpg',
      location: 'Vienna',
    ...
    {
      id: 6,
      src: 'https://i.imgur.com/9S6b50E.jpg',
      location: 'Swiss Alps',
    ...
    {
      id: 7,
      src: 'https://i.imgur.com/7uXwKYO.jpg',
      location: 'Denver',
      coords: { lat: 39.7300, lng: -104.9900 },
      year: '2024',
      orientation: 'portrait'
    ...
    {
      id: 8,
      src: 'https://i.imgur.com/mH1BSUD.jpg',
      location: 'Sevilla',
